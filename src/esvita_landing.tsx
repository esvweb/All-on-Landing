        ...
        <div className="max-w-7xl mx-auto">
          <div className={`text-center mb-12 transition-all duration-1000 ${isVisible['section-why'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <h2 className="text-3xl sm:text-5xl font-bold mb-4">
              Why Americans Choose <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">Turkey</span>
            </h2>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">Over 500,000 Americans traveled abroad for dental care in 2023. Here's why Turkey is the #1 choice.</p>
          </div>
      ...
      <section id="section-testimonials" className="py-16 sm:py-24 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <div className={`text-center mb-12 transition-all duration-1000 ${isVisible['section-testimonials'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <h2 className="text-3xl sm:text-5xl font-bold mb-4">
              Real Stories from <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">Real Americans</span>
            </h2>
